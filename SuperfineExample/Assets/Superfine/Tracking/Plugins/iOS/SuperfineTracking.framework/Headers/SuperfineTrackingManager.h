...
#import "SuperfineTrackingConfiguration.h"
#import "SuperfineTrackingSerializableValue.h"
#import "SuperfineTrackingCrypto.h"
#import "SuperfineTrackingDataBuilder.h"
#import "SuperfineTrackingEventNames.h"
 ...
 */
- (void)track:(NSString *)eventName value:(JSON_DICT _Nullable)value;
...
- (void)trackIAPBuyStart_pack:(NSString* _Nonnull)pack price:(NSString* _Nonnull)price amount:(float)amount currency:(NSString* _Nonnull)currency;
- (void)trackIAPBuyEnd_pack:(NSString* _Nonnull)pack price:(NSString* _Nonnull)price amount:(float)amount currency:(NSString* _Nonnull)currency isSuccess:(bool)isSuccess;
...
- (void)trackRateGame:(SuperfineTrackingStoreType)storeType;
...
- (void)trackCryptoPayment_pack:(NSString* _Nonnull)pack price:(NSString* _Nonnull)price amount:(float)amount currency:(NSString* _Nonnull)currency;
- (void)trackCryptoPayment_pack:(NSString* _Nonnull)pack price:(NSString* _Nonnull)price amount:(float)amount currency:(NSString* _Nonnull)currency type:(NSString* _Nonnull)type;
- (void)trackCryptoPayment_pack:(NSString* _Nonnull)pack price:(NSString* _Nonnull)price amount:(float)amount currency:(NSString* _Nonnull)currency type:(NSString* _Nonnull)type count:(int)count;
