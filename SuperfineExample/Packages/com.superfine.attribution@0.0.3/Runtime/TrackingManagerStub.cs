...
namespace Superfine.Tracking.Unity
{
    public class TrackingManagerStub : TrackingManagerBase
    {
        ...
        {
            Debug.Log(string.Format("Start Tracking Manager"));
        }
        ...
        {
            Debug.Log(string.Format("Track {0}: data = {1}", eventName, data));
        }
        ...
        {
            Debug.Log(string.Format("Track Rate Game"));
        }
        ...
        public override void TrackWalletLink(string wallet, string type = "ethereum")
        {
            Debug.Log(string.Format("Track Wallet Link: wallet = {0}, type = {1}", wallet, type));
        }

        public override void TrackWalletUnlink(string wallet, string type = "ethereum")
        {
        ...
        {
            Debug.Log(string.Format("Track Crypto Payment: pack = {0}, price = {1}, amount = {2}, currency = {3}, chain = {4}", pack, price, amount, currency, chain));
        }
    }
}