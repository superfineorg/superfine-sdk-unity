...
@protocol SuperfineTrackingApplicationProtocol;

@protocol SuperfineTrackingCrypto;
@protocol SuperfineTrackingMiddleware;

@interface SuperfineTrackingTenjinConfiguration : NSObject
...
@property (nonatomic, assign) SuperfineTrackingStoreType storeType;

@property (nonatomic, retain, nullable) SuperfineTrackingTenjinConfiguration *tenjinConfiguration;
