...
namespace Superfine.Unity
{
    ...
    {
        private static string Version = "0.0.15-stub";

        protected override void InitializeNative(SuperfineSDKSettings settings, List<string> moduleNameList)
        {
            Debug.Log(string.Format("Create Superfine SDK Manager with appId = {0}, appSecret = {1}", settings.appId, settings.appSecret));
        ...
        {
            Debug.Log(string.Format("Fetch Remote Config"));
        ...
        public override void Log(SuperfineSDKEvent eventData)
        {
            ...
            Debug.Log(string.Format("Log Event: {0}", eventData.ToString()));
        }
