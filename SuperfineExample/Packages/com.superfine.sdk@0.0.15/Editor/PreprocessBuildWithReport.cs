    ...
    public class PreprocessBuildWithReport : IPreprocessBuildWithReport
    {
        ...
        public void OnPreprocessBuild(BuildReport report)
        {
            ...
            if (settings != null)
            {
                ...
                PluginImporter googlePlayBillingPluginImporter = AssetImporter.GetAtPath("Packages/com.superfine.sdk/Plugins/Android/superfine-sdk-googleplay-billing-0.0.15.aar") as PluginImporter;
