...
namespace Superfine.Unity
{
    public class SuperfineSDKManagerIos : SuperfineSDKManagerBase
    {
        ...
        [DllImport("__Internal")]
        private static extern void SuperfineSDKLogIAPBuy(string pack, double price, int amount, string currency, string transactionId, string receipt);
        public override void LogIosIAPBuy(string pack, double price, int amount, string currency, string transactionId, string receipt)
        {
            SuperfineSDKLogIAPBuy(pack, price, amount, currency, transactionId, receipt);
        }
