...
namespace Superfine.Unity
{
    public abstract class SuperfineSDKManagerBase
    {
        ...
        public virtual void LogIosIAPBuy(string pack, double price, int amount, string currency, string transactionId, string receipt)
        {
        }

        public virtual void LogAndroidIAPBuy(string pack, double price, int amount, string currency, string data, string signature)
        {
        }
