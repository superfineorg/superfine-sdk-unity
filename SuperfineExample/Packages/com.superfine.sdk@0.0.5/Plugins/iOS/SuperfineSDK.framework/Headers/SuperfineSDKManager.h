...
- (void)logIAPBuy_pack:(NSString* _Nonnull)pack price:(double)price amount:(NSUInteger)amount currency:(NSString* _Nonnull)currency transactionId:(NSString* _Nullable)transactionId receipt:(NSString* _Nullable)receipt;
