...
namespace Superfine.Unity
{
    public class SuperfineSDKManagerIos : SuperfineSDKManagerBase
    {
        ...
        {
            SuperfineSDKInit(GetString(settings));
            hasInited = true;
        }
        ...
        [DllImport("__Internal")]
        private static extern void SuperfineSDKSetStartCallback([MarshalAs(UnmanagedType.FunctionPtr)]IntPtr callback, int requestCode);
        protected override void RegisterNativeStartCallback()
        {
            SuperfineSDKSetStartCallback(startHandlerPointer, 0);
        }

        [DllImport("__Internal")]
        private static extern void SuperfineSDKRemoveStartCallback(int requestCode);
        protected override void UnregisterNativeStartCallback()
        {
            SuperfineSDKRemoveStartCallback(0);
        }

        [DllImport("__Internal")]
        private static extern void SuperfineSDKSetStopCallback([MarshalAs(UnmanagedType.FunctionPtr)]IntPtr callback, int requestCode);
        protected override void RegisterNativeStopCallback()
        {
            SuperfineSDKSetStopCallback(stopHandlerPointer, 0);
        }

        [DllImport("__Internal")]
        private static extern void SuperfineSDKRemoveStopCallback(int requestCode);
        protected override void UnregisterNativeStopCallback()
        {
            SuperfineSDKRemoveStopCallback(0);
        }

        [DllImport("__Internal")]
        private static extern void SuperfineSDKSetPauseCallback([MarshalAs(UnmanagedType.FunctionPtr)]IntPtr callback, int requestCode);
        protected override void RegisterNativePauseCallback()
        {
            SuperfineSDKSetPauseCallback(pauseHandlerPointer, 0);
        }

        [DllImport("__Internal")]
        private static extern void SuperfineSDKRemovePauseCallback(int requestCode);
        protected override void UnregisterNativePauseCallback()
        {
            SuperfineSDKRemovePauseCallback(0);
        }

        [DllImport("__Internal")]
        private static extern void SuperfineSDKSetResumeCallback([MarshalAs(UnmanagedType.FunctionPtr)]IntPtr callback, int requestCode);
        protected override void RegisterNativeResumeCallback()
        {
            SuperfineSDKSetResumeCallback(resumeHandlerPointer, 0);
        }

        [DllImport("__Internal")]
        private static extern void SuperfineSDKRemoveResumeCallback(int requestCode);
        protected override void UnregisterNativeResumeCallback()
        {
            SuperfineSDKRemoveResumeCallback(0);
        }

        [DllImport("__Internal")]
        private static extern void SuperfineSDKSetDeepLinkCallback([MarshalAs(UnmanagedType.FunctionPtr)]IntPtr callback, int requestCode);
        protected override void RegisterNativeDeepLinkCallback()
        {
            SuperfineSDKSetDeepLinkCallback(deepLinkHandlerPointer, 0);
        }

        [DllImport("__Internal")]
        private static extern void SuperfineSDKRemoveDeepLinkCallback(int requestCode);
        protected override void UnregisterNativeDeepLinkCallback()
        {
            SuperfineSDKRemoveDeepLinkCallback(0);
        }

        [DllImport("__Internal")]
        private static extern void SuperfineSDKSetDeviceTokenCallback([MarshalAs(UnmanagedType.FunctionPtr)]IntPtr callback, int requestCode);
        protected override void RegisterNativePushTokenCallback()
        {
            SuperfineSDKSetDeviceTokenCallback(pushTokenHandlerPointer, 0);
        }

        [DllImport("__Internal")]
        private static extern void SuperfineSDKRemoveDeviceTokenCallback(int requestCode);
        protected override void UnregisterNativePushTokenCallback()
        {
            SuperfineSDKRemoveDeviceTokenCallback(0);
        }

        [DllImport("__Internal")]
        private static extern void SuperfineSDKSetSendEventCallback([MarshalAs(UnmanagedType.FunctionPtr)]IntPtr callback, int requestCode);
        protected override void RegisterNativeSendEventCallback()
        {
            SuperfineSDKSetSendEventCallback(sendEventHandlerPointer, 0);
        }

        [DllImport("__Internal")]
        private static extern void SuperfineSDKRemoveSendEventCallback(int requestCode);
        protected override void UnregisterNativeSendEventCallback()
        {
            SuperfineSDKRemoveSendEventCallback(0);
        }
