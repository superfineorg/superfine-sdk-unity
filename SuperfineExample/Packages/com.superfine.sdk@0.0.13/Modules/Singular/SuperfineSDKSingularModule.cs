...
{
    public class SuperfineSDKSingularModule : SuperfineSDKModule, SingularLinkHandler, SingularDeferredDeepLinkHandler
    {
        ...
        */
        ...
        private void SetupAppodealAdData(SingularAdData data, SimpleJSON.JSONObject networkData)
        {
            ...
            SetAdPlacementName(data, OptString(networkData, "placement"));
            SetPlacemenId(data, OptString(networkData, "placementId"));
