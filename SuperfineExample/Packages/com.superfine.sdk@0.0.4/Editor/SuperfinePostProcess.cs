...
namespace Superfine.Unity
{
    public class SuperfinePostProcess
    {
        ...
        private static void UpdateInfoPlist(string pathToBuiltProject)
        {
            ...
            if (settings != null && !string.IsNullOrEmpty(settings.advertisingAttributionReportEndpoint))
            {
                rootDict.SetString("NSAdvertisingAttributionReportEndpoint", settings.advertisingAttributionReportEndpoint);
            }
#endif
