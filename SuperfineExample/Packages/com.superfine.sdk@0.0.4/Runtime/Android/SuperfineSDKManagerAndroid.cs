...
namespace Superfine.Unity
{
    public class SuperfineSDKManagerAndroid : SuperfineSDKManagerBase
    {
        ...
        {
            javaClass.CallStatic("LogIAPBuyStart", pack, price, amount, currency);
        }

        public override void LogIAPBuyEnd(string pack, double price, int amount, string currency, bool isSuccess)
        {
            javaClass.CallStatic("LogIAPBuyEnd", pack, price, amount, currency, isSuccess);
        }

        public override void LogGoogleIAPBuyEnd(string pack, double price, int amount, string currency, string data, string signature, bool isSuccess)
        {
            javaClass.CallStatic("LogIAPBuyEnd", pack, price, amount, currency, data, signature, isSuccess);
        }
