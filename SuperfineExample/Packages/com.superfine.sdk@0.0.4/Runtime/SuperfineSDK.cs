...
namespace Superfine.Unity
{
    public static class SuperfineSDK
    {
        ...
        public static void LogIAPBuyStart(string pack, double price, int amount, string currency)
        {
            if (instance == null) return;
            instance.LogIAPBuyStart(pack, price, amount, currency);
        }

        public static void LogIAPBuyEnd(string pack, double price, int amount, string currency, bool isSuccess)
        {
            if (instance == null) return;
            instance.LogIAPBuyEnd(pack, price, amount, currency, isSuccess);
        }

        public static void LogAppleIAPBuyEnd(string pack, double price, int amount, string currency, string transactionId, string receipt, bool isSuccess)
        {
            if (instance == null) return;
            instance.LogAppleIAPBuyEnd(pack, price, amount, currency, transactionId, receipt, isSuccess);
        }

        public static void LogGoogleIAPBuyEnd(string pack, double price, int amount, string currency, string data, string signature, bool isSuccess)
        {
            if (instance == null) return;
            instance.LogGoogleIAPBuyEnd(pack, price, amount, currency, data, signature, isSuccess);
        }
